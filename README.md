...
useRouteMatch is used to match the current url
1. How would you explain form validation to someone who has never programmed before?
Validation is the shape of what you want your inputs to look like.
1. In 1-2 sentences, define end to end testing.
End to End testing is testing done on the whole application, it testes from the beginning of the application to the end.
